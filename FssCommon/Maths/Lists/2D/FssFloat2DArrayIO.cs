...
public static class FssFloat2DArrayIO
{
    ...
    public static void SaveToStreamWriter(FssFloat2DArray array, StreamWriter writer, int decimalPlaces)
    {
        string csvString = ToCSVString(array, decimalPlaces);
        writer.Write(csvString);
    }

    public static FssFloat2DArray LoadFromStreamReader(StreamReader reader)
    {
    ...
    // Binary read and write functions, but for the reader/writer as a parameter so the grid can be 
    // part of a larger file.

    public static void SaveToBinaryWriter(FssFloat2DArray array, BinaryWriter writer)
    {
        writer.Write(array.Width);
        writer.Write(array.Height);
    ...
    public static FssFloat2DArray LoadFromBinaryReader(BinaryReader reader)
    {
        int width  = reader.ReadInt32();
        int height = reader.ReadInt32();
        FssFloat2DArray array = new FssFloat2DArray(width, height);
