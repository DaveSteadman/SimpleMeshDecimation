...
public static class FssXYPointOperations
{
    ...
    public static double DotProduct(FssXYPoint a, FssXYPoint b)
    {
    ...
    public static double Angle(FssXYPoint fromPos, FssXYPoint toPos)
    {
    ...
    // FssXYPointOperations.OffsetPolar(fromPos, distance, angleRads);
    
    public static FssXYPoint OffsetPolar(FssXYPoint fromPos, double distance, double angleRads)
    {
    ...
    public static double AngleBetweenRads(FssXYPoint a, FssXYPoint b, FssXYPoint c)
    {
        double dx1 = a.X - b.X;
        double dy1 = a.Y - b.Y;
        double dx2 = c.X - b.X;
    ...
    public static FssXYPoint InsetPoint(FssXYPoint a, FssXYPoint b, FssXYPoint c, double t)
    {
        ...
        return new FssXYPoint(xInset, yInset);
    }

    // --------------------------------------------------------------------------------------------

    // given 3 points, find the area of the triangle, or return 0 if they are in a line.
    // FssXYPointOperations.TriangleArea(a, b, c);

    public static double TriangleArea(FssXYPoint a, FssXYPoint b, FssXYPoint c)
    {
    ...
    public static FssXYRect? AABBFromList(List<FssXYPoint> points)
    {
        // A singlular point is not a rect
        if (points.Count < 2)
            return null;
