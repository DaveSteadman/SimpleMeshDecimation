...
public class FssXYCircle : IFssXY
{
    ...
    {
        if (Radius < FssConsts.ArbitraryMinDouble) 
            return null;

        FssXYPoint tl = new FssXYPoint(Center.X - Radius, Center.Y + Radius);
        FssXYPoint br = new FssXYPoint(Center.X + Radius, Center.Y - Radius);
        return new FssXYRect(tl, br);
    }
