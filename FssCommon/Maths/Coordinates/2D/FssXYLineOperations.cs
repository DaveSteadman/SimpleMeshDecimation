...
public static class FssXYLineOperations
{
    // --------------------------------------------------------------------------------------------
    ...
    public static double ClosestDistanceTo(this FssXYLine line, FssXYPoint xy)
    {
    ...
    public static bool IsPointOnLine(this FssXYLine line, FssXYPoint xy, bool limitToLineSegment = true, double tolerance = 1e-6)
    {
        double x1 = line.P1.X;
        double y1 = line.P1.Y;
        double x2 = line.P2.X;
    ...
    /// </summary>
    public static bool DoesIntersect(FssXYLine l1, FssXYLine l2, double tol = 1e-9)
    {
    ...
    public static bool IsParallel(FssXYLine line1, FssXYLine line2)
    {
        ...
        return FssValueUtils.EqualsWithinTolerance(d, 0);
    }
    ...
    public static FssXYLine ExtendLine(FssXYLine line, double p1Dist, double p2Dist)
    {
        // Handle the case where the line has no length
        if (line.Length == 0) return line;

        FssXYPoint p1 = line.P1;
        FssXYPoint p2 = line.P2;
        ...
        return new FssXYLine(new FssXYPoint(p1x, p1y), new FssXYPoint(p2x, p2y));
    }

    // --------------------------------------------------------------------------------------------
    // Usage: FssXYLineOperations.InsetLine(line, insetDist);
    public static FssXYLine InsetLine(FssXYLine line, double insetDist)
    {
        // Handle the case where the line has no length
        if (line.Length == 0) return line;
    ...
    public static FssXYLine? ClipLineToRect(FssXYLine line, FssXYRect rect)
    {
        double x0 = line.P1.X;
        double y0 = line.P1.Y;
        double x1 = line.P2.X;
        ...
        return new FssXYLine(new FssXYPoint(clippedX0, clippedY0), new FssXYPoint(clippedX1, clippedY1));
    }
    ...
    public static FssXYLine OffsetInward(FssXYLine line, FssXYPoint oppositePoint, double inset)
    {
        ...
        var toC = new FssXYPoint(oppositePoint.X - mid.X, oppositePoint.Y - mid.Y);
